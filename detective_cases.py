...
def main():
    ...
    app.add_handler(CommandHandler("tanla", tanla))
    app.add_handler(CommandHandler("dalil", dalil))
    app.add_handler(CommandHandler("javob", javob))
    app.add_handler(CommandHandler("yechim", yechim))
    app.add_handler(CommandHandler("ball", ball))
    app.add_handler(CommandHandler("tolov", tolov))
    print("Bot ishga tushdi... (@finder_topBot)")
    app.run_polling()
